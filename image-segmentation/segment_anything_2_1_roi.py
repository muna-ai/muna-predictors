...
REPO_ID = "mabote-itumeleng/ONNX-SAM2-Segment-Anything"
encoder_path = hf_hub_download(repo_id=REPO_ID, filename="sam2.1_hiera_small_encoder.onnx")
decoder_path = hf_hub_download(repo_id=REPO_ID, filename="sam2.1_hiera_small_decoder.onnx")
...
@compile(
    ...
    description="Segment an image region of interest using Segment Anything 2.1.",
    sandbox=Sandbox()
...
def predict(
    ...
    """
    Segment an image region of interest using Segment Anything 2.1.
    """
    # Preprocess image
    ...
    orig_im_size = array([height, width], dtype="int32")
